...
public class NoFlyZoneFabric implements ModInitializer {
    ...
    private void registerPayloads() {
        ...
        ServerPlayNetworking.registerGlobalReceiver(ModPayloads.SET_ZONE_TYPE, (payload, context) ->
            context.server().execute(() -> SetZoneHandler.handle(context.player(), payload.enabled())));
